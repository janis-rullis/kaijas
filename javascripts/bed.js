...
function setupEvents()
{
	...
	x.onmousedown = showMenus;
	$("#smWin").mousedown(function () {
		window.location = 'window.html';
	})
	$("#smPc").mousedown(function () {
		window.location = 'pc.html';
	})
	$("#mapTable").mousedown(function () {
		window.location = 'table.html';
	})
	$("#smPhotos").mousedown(function () {
		window.location = 'images.html';
	})
	$("#smNote").mousedown(function () {
		window.location = 'note.html';
	})
	$("#smBook").mousedown(function () {
		window.location = 'book.html';
	})
	$("#smBed").mousedown(function () {
